		...
		*/
		$("#phoneCheck").click(function(){
			...
			$.ajax({
				...
				data: {
					userId : $("#teacherPhone").val()	//컨트롤러에서 요구하는 항목. 밑에 있는 항목이 아님.	
				},
				dataType: "text",
				success: function(data){
					if(data=="true"){
	...
	<form name="insertForm" method="post" action="${pageContext.request.contextPath}/main/insert">
	  <h1> 강사 회원가입 </h1>
	    ...
	    <table>
	      ...
	      <tr>
	          <th>* 강사 비밀번호</th>
	          <td class=""><input type="password" id="teacherPwd" class="" placeholder="영소문자,대문자,숫자를 조합하여 최소 8자리 이상 입력해주세요." required/>
