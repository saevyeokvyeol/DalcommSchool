					...
					$.ajax({
						...
						success: function(result){
							...
							$.each(result, function(index, item){
								text += `<input type="radio" class="btn-check shadow-none" name="placeRegion" id="\${item.regionName}" value="\${item.regionId}"><label class="btn btn-outline-primary shadow-none" for="\${item.regionName}">\${item.regionName}</label>`;
							})
