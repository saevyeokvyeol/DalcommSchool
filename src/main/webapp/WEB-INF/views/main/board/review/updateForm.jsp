...
<form id="updateForm" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/main/board/review/update?${_csrf.parameterName}=${_csrf.token}">
	...
	<table>
	  	...
	  	<tr>
	    	<th>내용</th>
	    	<td>
	    		<textarea name="reviewContent" placeholder="후기를 자유롭게 입력해주세요.">${review.reviewContent}</textarea>
	    	</td>
	  	</tr>
	</table>
