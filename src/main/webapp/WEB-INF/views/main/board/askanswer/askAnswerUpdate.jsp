...
<form name=updateForm method=post action="${pageContext.request.contextPath}/main/board/askanswer/update" >
...
<hr>
<div align=right><span style="font-size:9pt;">&lt;<a href="${pageContext.request.contextPath}/main/board/askanswer/askAnswer">리스트로 돌아가기</a>&gt;</span></div>
