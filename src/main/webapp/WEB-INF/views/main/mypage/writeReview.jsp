...
<!-- 			<div class="modal-body"> -->
				<form id="reviewInsertForm" enctype="multipart/form-data" method="post" action="${pageContext.request.contextPath}/main/mypage/review/insert?${_csrf.parameterName}=${_csrf.token}">
				<input type="hidden" name="classId" value="${classId}">
					<table>
						...
						<tr>
						  <th>내용</th>
						  <td>
						    <textarea name="reviewContent" id="summernote" placeholder="후기를 자유롭게 입력해주세요. 욕설 / 비방은 관리자에 의한 비공개 처리 및 처벌될 수 있습니다."></textarea>
						  </td>
						</tr>
					</table>
					<input type="submit" id="insertReview" value="후기 등록">
				</form>
<!-- 			</div> -->
<!-- 		</div> -->
<!-- 	</div> -->
