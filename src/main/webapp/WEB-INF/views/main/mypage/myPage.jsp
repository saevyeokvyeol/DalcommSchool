                ...
                <div class="side-bar">
                    <div class="user-info">
                        <ul class="meta list list-unstyled">
                            <span class="fa fa-user"></span>&nbsp;유저아이디
                        </ul>
                    </div>
                    <nav class="side-menu">
                        <ul class="nav">
                            <li><a href="#"><span class="fa fa-cog"></span>&nbsp;회원 정보 수정</a></li>
                            ...
                            <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp;클래스 문의</a></li>
                            <li><a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>&nbsp;1대1 문의</a></li>
                            <br>
                            <li><a href="#"><i class="fa fa-times-circle" aria-hidden="true"></i>&nbsp;회원 탈퇴</a></li>
                        </ul>
                    </nav>
                </div>
