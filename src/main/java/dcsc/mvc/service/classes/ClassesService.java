...
import dcsc.mvc.domain.classes.Class;
...
public interface ClassesService {
	 ...
	 * @return List<Class>
	 * */
	List<Class> selectSearch(Class classes, String keyword, String sort, String newClass, String timeOut);
	 ...
	 * @return Class
	 * */
	Class selectByClassId(Long ClassId);
}